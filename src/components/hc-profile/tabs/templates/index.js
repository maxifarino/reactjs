...
class Templates extends React.Component {
  ...
  goToBuilder(template) {
    ...
    if(!template){
      this.props.builderActions.setHiringClient(this.props.fromhc? this.props.match.params.hcId:'');
    }
    this.props.history.push(`/communication-templates/builder${this.props.fromhc ? '/'+this.props.match.params.hcId : ''}`);
  }
