    ...
    return (
      <div className="add-item-view add-entity-form-small">
        <div className="add-item-header">
          <h1>Other Coverage: [Coverage Type]</h1>
        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(AddOtherCoveragesModal);
