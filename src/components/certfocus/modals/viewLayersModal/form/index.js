...
class ProcessingForm extends Component {
  ...
  render() {    
    ...
    const disabledByDocumentStatus = document && document.DocumentStatusID === 11 ? true : false;  // Processing Complete Status
    ...
    const rightFields = [
      { 
        ...
        defaultValue: 1,   // Certificate of Insurance by default
      ...
      { 
        ...
        conditional: true, 
        show: (Number(documentTypeCurrentValue) === 1 && disabledByRole),
        disabled: disabledByDocumentStatus
      },
      { 
        name: 'urgent', 
      ...
      { 
        ...
        type: 'date',
        conditional: true, 
        show: (Number(documentTypeCurrentValue) !== 1)
      },
      { 
        name: 'expireDate', 
        label: 'Expire Date',
      ...
      { 
        ...
        defaultValue: 1, // Pending Review by default
        conditional: true, 
        show: (Number(documentTypeCurrentValue) !== 1)
      },
    ];    
                ...
                <ul>
                  <li>
                    <a
                      ...
                      style={{ display: (disabledByDocumentStatus) ? 'none' : 'inline' }}
                      onClick={handleSubmit(values => 
                        this.props.onSubmit({ 
                        ...values,
                        submitType: 'sendToProcessing'
                      }))}
                    >
                      Send to Processing
                    </a>                    
                  ...
                  <li>
                    <a
                      className="list-view-nav-link nav-bn no-overlapping"
                      style={{ display: (((Number(documentTypeCurrentValue) === 1) && (disabledByRole)) || disabledByDocumentStatus) ? 'none' : 'inline' }}
                      onClick={handleSubmit(values => 
                        this.props.onSubmit({ 
                        ...values,
                        submitType: 'sendToDataEntry'
                      }))}
                    >
                      Send to Data Entry
                    </a>                    
                  ...
                  <li>
                    <a
                      className="list-view-nav-link nav-bn no-overlapping"
                      style={{ display: ((Number(documentTypeCurrentValue) === 1) && (disabledByRole)) ? 'none' : 'inline' }}
                      onClick={handleSubmit(values => 
                        this.props.onSubmit({ 
                        ...values,
                        submitType: 'doDataEntry'
                      }))}
                    >
                      Do Data Entry
                    </a>                    
                  ...
                  <li>
                    <a
                      className="list-view-nav-link nav-bn no-overlapping"
                      style={{ display: Number(documentTypeCurrentValue) === 1 ? 'none' : 'inline' }}
                      onClick={handleSubmit(values => 
                        this.props.onSubmit({ 
                        ...values,
                        submitType: 'save'
